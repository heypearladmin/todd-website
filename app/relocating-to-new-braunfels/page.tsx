...
export const metadata: Metadata = {
  title: "Relocating to New Braunfels, TX | Neighborhood Guide",
  description:
  ...
  return (
    <>
      ...
      <JsonLd
        schema={
          howToSchema({
            name: "How to relocate to New Braunfels, TX",
            description: "Todd Spencer's step-by-step process for guiding out-of-area buyers through relocating to New Braunfels and Comal County.",
      ...
      <main id="main" className="bg-paper">
        ...
        <section className="section-wrap border-t border-ink/[0.07] py-20 md:py-28">
          ...
          <h2 className="display-lg mt-6 text-ink">Explore the neighborhoods relocators land in most.</h2>
          <div className="mt-8 flex flex-wrap gap-4">
            {[
              { slug: "gruene", label: "Gruene" },
              { slug: "downtown-new-braunfels", label: "Downtown New Braunfels" },
