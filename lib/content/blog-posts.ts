...
export const journalPosts: JournalPost[] = [
  {
    ...
    imageAlt: "Comal County neighborhood street in afternoon light with mature oak canopy.",
  ...
  },
  {
    ...
    imageAlt: "Dog wading happily in the clear Comal River on a sunny Texas morning.",
  ...
  },
  {
    ...
    dek: "Comal ISD or New Braunfels ISD — your child's assignment depends on which side of the street you buy on. Zone maps, campus ratings, and which neighborhoods feed the strongest schools.",
  ...
  },
  {
    ...
    dek: "Texas has no state income tax. Homeowners 65+ qualify for a property tax freeze. Here's the full financial and lifestyle case for retiring to New Braunfels — from healthcare proximity to river life.",
